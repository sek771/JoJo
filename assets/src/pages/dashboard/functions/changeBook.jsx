...
const changeBook = () => {
  ...
  const SubmitForm = () => {
    ...
    axios
      .put("http://localhost:8000/api/books", changeBook, config)
      .then((response) => {
      ...
      <form action="">
        <div>
          ...
          <input
            type="text"
            onChange={(event) => {
              setChangeBook({ ...changeBook, title: event.target.value });
            }}
          />
        </div>
        <div>
          ...
          <input
            type="text"
            onChange={(event) => {
              setChangeBook({ ...changeBook, subTitle: event.target.value });
            }}
          />
        </div>
        <div>
          ...
          <input
            type="text"
            onChange={(event) => {
              setChangeBook({ ...changeBook, authors: [event.target.value] });
            }}
          />
        </div>
        <div>
          ...
          <input
            type="text"
            onChange={(event) => {
              setChangeBook({ ...changeBook, country: event.target.value });
            }}
          />
        </div>
        <div>
          ...
          <input
            type="text"
            onChange={(event) => {
              setChangeBook({ ...changeBook, editor: [event.target.value] });
            }}
          />
        </div>
        <div>
          ...
          <input
            type="text"
            onChange={(event) => {
              setChangeBook({ ...changeBook, image: event.target.value });
            }}
          />
        </div>
        <div>
          ...
          <input
            type="text"
            onChange={(event) => {
              setChangeBook({ ...changeBook, tome: [event.target.value] });
            }}
          />
        </div>
        <div>
